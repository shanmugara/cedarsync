...
//+kubebuilder:rbac:groups=cedarsync.omegahome.net,resources=cedarpolicies,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cedarsync.omegahome.net,resources=cedarpolicies/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cedarsync.omegahome.net,resources=cedarpolicies/finalizers,verbs=update
...
func (r *CedarPolicyReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&cedarsyncv1alpha1.CedarPolicy{}).
		Complete(r)
}
